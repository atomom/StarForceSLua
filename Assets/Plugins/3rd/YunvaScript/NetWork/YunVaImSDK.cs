...
//			EventListenerManager.AddListener(ProtocolEnum.IM_CHANNEL_GETINFO_RESP, getChannelInfoResponse);
        ...
        private System.Action<ImSetUserInfoResp> ActionSetUserInfo;
        /// <summary>
        /// 修改个人账号信息
        /// </summary>
        /// <param name="userId">用户ID</param>
        public void YunVaSetUserInfo(string nickname, System.Action<ImSetUserInfoResp> Response, string iconUrl = "", string level = "", string vip = "", string ext = "", int sex = 0)
        {
            ...
            uint parser = YunVaImInterface.instance.YVpacket_get_parser();
            YunVaImInterface.instance.YVparser_set_string(parser, 1, nickname);
            YunVaImInterface.instance.YVparser_set_string(parser, 2, iconUrl);
            YunVaImInterface.instance.YVparser_set_string(parser, 3, level);
            YunVaImInterface.instance.YVparser_set_string(parser, 4, vip);
            YunVaImInterface.instance.YVparser_set_string(parser, 5, ext);
            YunVaImInterface.instance.YVparser_set_integer(parser, 6, sex);

            YunVaImInterface.instance.YV_SendCmd(CmdChannel.IM_LOGIN, (uint)ProtocolEnum.IM_SETUSERINFO_REQ, parser);
        }

        private void SetUserInfo(object data)
        {
            if (data is ImSetUserInfoResp)
            {
                if (ActionSetUserInfo != null)
                {
        ...
        public void RecordStopRequest(System.Action<ImRecordStopResp> RecordResponse, System.Action<ImUploadFileResp> UploadResp=null, System.Action<ImSpeechStopResp> SpeechResp=null)
        {
            ...
            uint parser = YunVaImInterface.instance.YVpacket_get_parser();
            int ret = YunVaImInterface.instance.YV_SendCmd(CmdChannel.IM_TOOLS, (uint)ProtocolEnum.IM_RECORD_STOP_REQ, parser);
            Debug.Log("@RecordStopRequest@ ret=" + ret);
        }
        ...
        private System.Action<ImSpeechStopResp> ActionSpeechResp;
        /// <summary>
        /// 开始语音识别
        /// </summary>
        /// <param name="filePath"></param>
		...
		public void SpeechStartRequest(string filePath, string ext, System.Action<ImSpeechStopResp> Response,int type=(int)yvspeech.speech_file,string url="")
        {
            ...
            //else
            //{
            //    Debug.LogError("ext标识已经存在，必须传一个唯一值");
            //}
        ...
        #endregion
        private System.Action<ImFriendAddRespond> ActionFriendAddRespond;
        /// <summary>
        /// 发送添加好友请求
        /// </summary>
        /// <param name="userId"></param>
        /// <param name="greet"></param>
        public void FriendAddRequest(int userId, System.Action<ImFriendAddRespond> Response, string greet = "")
        {
        ...
        {
            if (!(data is ImFriendAddRespond))
                return;
            if (ActionFriendAddRespond != null)
            {
	...
	//	private  System.Action<SendFriendMsgResp>  System.ActionSendFriendMsgResp;
        ...
        public int SendP2PTextMessage(int userId, string textMsg,  System.Action<ImChatFriendResp> Response, string flag, string ext = "")
		{
            ...
            Debug.Log("SendP2PTextMessage ret=" + result);
            if (result == 0)
            {
        ...
        /// <param name="ext"></param>
         public int SendP2PTextMessage(string gameUserID, string textMsg,  System.Action<ImChatFriendResp> Response, string flag, string ext = "")
        {
             int ret=0;
        ...
        public int SendP2PVoiceMessage(int userId, string filePath, int audioTime, string txt,  System.Action<ImChatFriendResp> Response, string flag, string ext = "")
		{
            ...
            Debug.Log("SendP2PVoiceMessage ret=" + result);
			if (result == 0) {
...
//                Debug.Log(string.Format("发送文本的flag:{0},userid:{1},result:{2},data.msg:{3}", dataResp.flag, dataResp.userId, dataResp.result,dataResp.msg));
        ...
        /// <param name="flag"></param>
        /// <param name="ext"></param>
        public int  SendP2PVoiceMessage(string gameUserID, string filePath, int audioTime, string txt, System.Action<ImChatFriendResp> Response, string flag, string ext = "")
        {
            int ret = 0;
