...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        public static void AttachLuaEntity(this EntityComponent entityComponent, LuaEntity entity, int ownerId, string parentTransformPath = null, object userData = null)
        {
        ...
        public static void ShowLuaEntity(this EntityComponent entityComponent, int id, string assetName , string entityGroup, object data)
        { 
            entityComponent.ShowEntity(id, typeof(LuaEntity), AssetUtility.GetEntityAsset(assetName) , entityGroup, data);
        }

        public static void HideLuaEntity(this EntityComponent entityComponent, LuaEntity entity)
        {
            entityComponent.HideEntity(entity.Entity);
        }
